...
def find_urls(input_string):
    ...
    regex_1 = r"(http:\/\/[\S]+\.*[\S][\S]+)"
    result_1 = re.findall(regex_1, input_string)
    regex_2 = r"(https:\/\/[\S]+\.*[\S][\S]+)"
    result_2 = re.findall(regex_2, input_string)
    final_list = result_1 + result_2
    return final_list
...
def get_five_tweets(input_string):
	...
	retun_tweets = []
	for t in CACHE_DICTION[unique_identifier]:
		retun_tweets.append(t["text"])
	return retun_tweets
